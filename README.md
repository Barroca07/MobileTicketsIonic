[README (2).md](https://github.com/user-attachments/files/26492013/README.2.md)
# MobileTicketsIonic
...
Instalação
Clonar e entrar na pasta: git clone https://github.com/Barroca07/MobileTicketsIonic.git cd MobileTicketsIonic
